...
def on_message(client, userdata, message):
    print("Received message from RASPI:", message.topic)
    ...
    insertQ = """ INSERT INTO shohan."sensorData1" ("machine_id", "timestamp", "date", "pressure", "temperature", "humidity")
                    VALUES(%s,%s,%s,%s,%s,%s)"""
...
client.subscribe("Binil/Machinex1/SensorData")
#time.sleep(1000)
